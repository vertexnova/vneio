#==============================================================================
# VneIo Windows Build Script (PowerShell)
#==============================================================================
...
$ConfigureCmd = "cmake -B `"$BuildDir`" -S `"$ProjectRoot`" -DCMAKE_BUILD_TYPE=$BuildType -DVNEIO_LIB_TYPE=$LibType -DVNEIO_BUILD_TESTS=ON $Generator"
