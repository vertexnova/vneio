...
# (shared + image-only defaults match CI: mesh/Assimp omitted on wasm)
#==============================================================================
...
print_status "VneIo Web — $PROJECT_ROOT — $BUILD_TYPE — lib $LIB_TYPE — jobs $JOBS"
